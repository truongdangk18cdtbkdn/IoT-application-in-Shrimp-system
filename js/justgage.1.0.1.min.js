...
JustGage=function(x){
	if(!x.id){alert("Missing id parameter for gauge!");
	return false
	}
	...
	var c,l;if((d/q)>1.25){c=1.25*q;l=q}else{c=d;l=d/1.25}var i=(d-c)/2;var g=(q-l)/2;
	var s=((l/8)>10)?(l/10):10;var n=i+c/2;
	var m=g+l/6.5;var k=((l/6.4)>16)?(l/6.4):16;
	var r=i+c/2;
	var p=g+l/1.4;
	...
	this.canvas.customAttributes.pki=function(K,L,N,E,O,F,D,y){
		...
		G=E/2-E/10,J=G-E/6.666666666666667*y,
		C=E/2+F,A=O/1.25+D,H=E/2+F+G*Math.cos(B),
		P=O-(O-A)+D-G*Math.sin(B),
		M=E/2+F+J*Math.cos(B),
		z=O-(O-A)+D-J*Math.sin(B),I;
		I+="M"+(C-J)+","+A+" ";
		I+="L"+(C-G)+","+A+" ";
		I+="A"+G+","+G+" 0 0,1 "+H+","+P+" ";
		I+="L"+M+","+z+" ";
